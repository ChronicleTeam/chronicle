...
export const getAllAccess = async (resource: string, resource_id: string): Promise<Access[]> => GET<Access[]>(`/${resource}/${resource_id}/access`);
...
export const createAccess = async (resource: string, resource_id: string, access: Access): Promise<void> => POST<void>(`/${resource}/${resource_id}/access`, access);
...
export const deleteAccess = async (resource: string, resource_id: string, username: string): Promise<void> => DELETE(`/${resource}/${resource_id}/access`, [{ username }]);
...
export const patchAccess = async (resource: string, resource_id: string, username: string, role: AccessRole): Promise<void> => PATCH<void>(`/${resource}/${resource_id}/access`, [{ username, access_role: role }]);
